...
import { SoftTokenDrawerComponent } from './soft-token-drawer.component';
...
describe('SoftTokenDrawerComponent', () => {
  let component: SoftTokenDrawerComponent;
  let fixture: ComponentFixture<SoftTokenDrawerComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [SoftTokenDrawerComponent],
    ...
    fixture = TestBed.createComponent(SoftTokenDrawerComponent);
